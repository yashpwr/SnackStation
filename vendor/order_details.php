    ...
    <main class="body-content">
        ...
        <div class="ms-content-wrapper">
            <div class="row">
                ...
                order_details.country, order_details.pincode, order_details.phone, order_details.trn_date, order_details.id as orderid
                FROM `order` 
                    ...
                    <div class="ms-panel ms-panel-fh">
                        <div class="ms-panel-body">
                            ...
                            <div class="new">
                                ...
                                <a href="update_status.php?id=<?php echo $row["orderid"]; ?>"><button type="button" class="btn btn-primary">Ready to Deliver</button></a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
