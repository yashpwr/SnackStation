...
?>
<?php
$sql = "CREATE TABLE `snacks_category` (
...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO snacks_category (category, added_by, trn_date) 
  			  VALUES('$category', '$added_by', '$trn_date')";
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="validationCustom18" name="category" placeholder="Category Name" required>
                                        </div>
                                    </div>
