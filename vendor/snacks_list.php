                                ...
                                <div class="ms-panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover thead-primary" id="datatable">
                                            ...
                                            <tbody>
                                                <?php
                                                $state_query = "select * from snacks WHERE uploaded_by = '$id'";
                                                $state_result = mysqli_query($db, $state_query);
                                                $count = 1;
                                                while ($r = mysqli_fetch_array($state_result)) { ?>
                                                    <tr>
                                                        <td> <img src='/SnacksStation/uploads/admin-snacks-img/<?php echo $r['img']; ?>' style='width:50px; height:30px;'><a href='snacks_details.php?id=<?php echo $r["id"]; ?>'><?php echo $r['name']; ?></a></td>
                                                        <td><?php echo $r['category']; ?></td>
                                                        <td><?php echo $r['quantity']; ?></td>
                                                        <td><?php echo $r['price']; ?></td>
                                                        <td><?php echo $r['status']; ?></td>
                                                        <td><a href='edit_snack.php?id=<?php echo $r["id"]; ?>'><i class='fas fa-pencil-alt text-secondary'></i></a></td>
                                                        <td><a href="snacks_delete.php?id=<?php echo $r["id"]; ?>"><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                                                    </tr>
                                                <?php $count++;
                                                } ?>
                                            </tbody>
