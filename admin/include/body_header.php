<?php
  ...
  $queryshow = "SELECT * from admin WHERE username='" . $username . "'";
      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="ms-user-img ms-img-round float-right" src="assets/img/costic/customer-1.jpg" style="height: 40px; width: 40px;" alt="people">
          </a>
