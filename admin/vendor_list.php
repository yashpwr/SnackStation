                                ...
                                <div class="ms-panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover thead-primary" id="datatable">
                                            ...
                                            <tbody>
                                                <?php
                                                $state_query = "select * from vendor";
                                                $state_result = mysqli_query($db, $state_query);
                                                $count = 1;
                                                while ($r = mysqli_fetch_array($state_result)) { ?>
                                                    <tr>
                                                        <th scope="row"><?php echo $r['r_id'];?></th>
                                                        <td><a href='vendor_details.php?id=<?php echo $r["id"]; ?>'><?php echo $r['r_name'];?></a></td>
                                                        <td> <?php echo $r['fname'] ." " . $r['lname'];?></td>
                                                        <td><?php echo $r['email'];?></td>
                                                        <td><?php echo $r['r_location'];?></td>
                                                        <td><?php echo $r['trn_date'];?></td>
                                                        <td><a href='vendor_edit.php?id=<?php echo $r["id"]; ?>'><i class='fas fa-pencil-alt text-secondary'></i></a></td>
                                                        <td><a href="delete_vendor.php?id=<?php echo $r["id"]; ?>"><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                                                    </tr>
                                                <?php $count++;
                                                } ?>
                                            </tbody>
