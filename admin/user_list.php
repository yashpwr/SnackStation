                                ...
                                <div class="ms-panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover thead-primary" id="datatable">
                                            ...
                                            <tbody>
                                                <?php
                                                $state_query = "select * from users";
                                                $state_result = mysqli_query($db, $state_query);
                                                $count = 1;
                                                while ($r = mysqli_fetch_array($state_result)) { ?>
                                                    <tr>
                                                        <td> <a href='user_details.php?id=<?php echo $r["id"]; ?>'><?php echo $r['fname'] ." " . $r['lname'];?></a></td>
                                                        <td><?php echo $r['email'];?></td>
                                                        <td><?php echo $r['trn_date'];?></td>
                                                        <td>
                                                        <a href="user_delete.php?id=<?php echo $r["id"]; ?>"><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                                                    </tr>
                                                <?php $count++;
                                                } ?>
                                            </tbody>
