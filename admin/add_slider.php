...
if (isset($_POST['submit']) && isset($_FILES['img'])) {
    ...
    if (in_array($fileType, $allowTypes)) {
        if (move_uploaded_file($_FILES["img"]["tmp_name"], $targetFilePath)) {
            ...
            $queryi = "INSERT into slider (img, title, description, trn_date)
               VALUES ('$img','$title','$description', '$trn_date');";
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-10 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="validationCustom02" name="title" placeholder="Slider Title" required>
                                        </div>
                                    </div>
                                    <div class="col-md-10 mb-3">
                                        <label for="validationCustom02">Slider Description</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="validationCustom02" name="description" placeholder="Slider Description" required>
                                        </div>
                                    </div>
                                </div>
